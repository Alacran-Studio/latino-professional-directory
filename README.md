...
We use [https://ui.shadcn.com/](Shadcn) for our `SideBar`.
Many of the components generated by Shadcn are contained within `src/components/ui`.
For a more detailed look, check out [https://github.com/Alacran-Studio/lpdd/pull/23/files](this pull request).
